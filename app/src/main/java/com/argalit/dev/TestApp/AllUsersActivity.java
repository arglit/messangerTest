...
public class AllUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allDatabaseUserreference.keepSynced(true);//загрузка датабазы офлайн
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<AllUsers,AllUsersViewHolder>firebaseRecyclerAdapter =
                ...
                {
                    @Override
                    protected void populateViewHolder(AllUsersViewHolder viewHolder, AllUsers model, final int position)//Показ элементов на all_users_list
                    {
                        ...
                        viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                String visit_user_id = getRef(position).getKey();//Поиск уник.номера пользователя в датабазе по позиции в списке
